...
class Comment(ndb.Model):
    ...
    author_institution = ndb.KeyProperty(kind="Institution", required=True)
    ...
    def make(comment):
        ...
        return {
            ...
            'author_institution': comment.author_institution.urlsafe(),

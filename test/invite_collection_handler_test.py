...
class InviteCollectionHandlerTest(TestBaseHandler):
    ...
    def test_post_invite_institution(self, verify_token):
        ...
        self.assertEqual(invite_obj.admin_key, self.mayza.key,
                         "The admin_key expected was Mayza")
    ...
    def test_post_invite_user_member_of_other_institution(self, verify_token):
        invite = self.testapp.post_json("/api/invites", {
            ...
            'admin_key': self.tiago.key.urlsafe(),
            'type_of_invite': 'USER',
        ...
        self.assertEqual(invite_obj.admin_key, self.tiago.key,
                         "The admin_key expected was Tiago")
